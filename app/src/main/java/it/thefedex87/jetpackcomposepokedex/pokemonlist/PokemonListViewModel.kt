package it.thefedex87.jetpackcomposepokedex.pokemonlist
...
import it.thefedex87.jetpackcomposepokedex.util.Constants.PAGE_SIZE
            ...
            when (result) {
                is Resource.Success -> {
                    ...
                    val pokedexEntries = result.data.results.mapIndexed { _, entry ->
                        ...
                        val url =
                            "https://raw.hithubusercontent.com/PokeAPI/sprites/master/sprites/$number.png"
                        PokedexListEntry(
